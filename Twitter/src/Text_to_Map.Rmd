...
# save it in html
library("htmlwidgets")
# saveWidget(Twitter_wd,"tmp.html",selfcontained = F)

# and in png or pdf
webshot("tmp.html","Twitter_wd.png", delay =5, vwidth = 480, vheight=480)
```
...
# Map
map_title2 <- tags$p(tags$style('p {color: black; font-size: 15px; family: serif}'),
