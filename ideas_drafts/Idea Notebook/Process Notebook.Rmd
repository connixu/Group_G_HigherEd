...
df <- read_csv('../data/2019_College_Scorecard_Valid_Admissions_Data.csv')
...
We started by testing whether or not we would be able to generate a graph of where universities in the US are located. 
