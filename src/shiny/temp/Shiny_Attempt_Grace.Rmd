...
```{r, echo=FALSE}
Tweets_state <- readRDS('~/Documents/GitHub/DataVisualization/Group_G_HigherEd/src/Data/Geotweets_state_cleaned.RDS') %>% 
...
SearchTrend <- read_csv('~/Documents/GitHub/DataVisualization/Group_G_HigherEd/src/Data/SearchTrend.csv', col_names = TRUE, skip = 2) %>% 
...
Schools <- read_csv('~/Documents/GitHub/DataVisualization/Group_G_HigherEd/src/Data/2010_2019_student_debt.csv') %>%
