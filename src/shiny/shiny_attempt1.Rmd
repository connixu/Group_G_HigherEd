    ...
    tabItems(
      ...
      tabItem(tabName = "loans", class = "active",
        fluidPage(
          ...
          tags$div(
            tags$h1("Student Debt", align = "center")),
        fluidRow(align = "left",
                 column(12, wellPanel(DTOutput("table")))),
                 #column(4, wellPanel(highcart2Output("treemap")))), # finish output function
        fluidRow(align = "left",
                 column(5, wellPanel(p("Connie put explanation here.")))),
        fluidRow(align = "left",
                 column(5, wellPanel(plotOutput("admissions_scatter")))),
        fluidRow(align = "left",
                 column(12, wellPanel(plotlyOutput("plotly")))),
        fluidRow(column(12, wellPanel(sliderInput(inputId = "year",
                                                  label = "Year",
